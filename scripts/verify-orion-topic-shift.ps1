...
try {
    ...
    Assert-Condition ($config.ContainsKey("agent_name")) "config.json is missing agent_name."
    ...
    Assert-Condition (-not [string]::IsNullOrWhiteSpace($config.agent_name)) "config.json agent_name is empty."
